...
public class BookingServiceImpl implements BookingService {
    ...
    public BookingServiceImpl(DBUtil dbUtil) {
        this.dbUtil = dbUtil;
    }
    ...
    public List<HistoryBean> getAllBookingsByCustomerId(String customerEmailId) throws TrainException {
        ...
        try (Connection con = dbUtil.getConnection();
            ...
            throw new TrainException("Failed to fetch bookings for customer: " + customerEmailId);
        }
        return transactions;
    }
    ...
    public HistoryBean createHistory(HistoryBean details) throws TrainException {
        ...
        try (Connection con = dbUtil.getConnection();
            ...
            throw new TrainException("Failed to create booking history.");
        }
    }
}
